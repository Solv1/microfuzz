...
volatile size_t g_nSeeds __attribute__((section(".fuzzbss")));
...
volatile uint16_t g_coverageList[MAX_BLOCKS_PER_INPUT] __attribute__((section(".fuzzbss")));
volatile uint16_t * g_covListPtr __attribute__((section(".fuzzbss"))) = 0;
uint32_t * g_sutStartPtr __attribute__((section(".fuzzbss"))) = 0;
uint8_t g_isIncreasing __attribute__((section(".fuzzbss"))) = 0;
uint32_t g_iterations __attribute__((section(".fuzzbss"))) = 0;
...
volatile uint16_t * g_covListPtr = 0;
...
//        }
                ...
                for(i = 0; i < rndValue; i++){
                        ...
                        case 0:
                                ...
                                break;
                        case 1:
                                testCase[rndByte] = testCase[rndByte] + (g_mutContext.stageCycles % 34); 
                                break;
                        case 2:
