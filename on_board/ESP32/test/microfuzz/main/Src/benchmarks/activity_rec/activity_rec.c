...
void accel_sample(uint32_t seed, accelReading *result)
{
...
void acquire_window(uint32_t seed, accelWindow window)
{
    accelReading sample;
...
void warmup_sensor(uint32_t seed)
{
...
void train(uint32_t seed, features_t *classModel)
{
...
void recognize(uint32_t seed, model_t *model)
{
    stats_t stats;
    accelWindow sampleWindow;
    features_t features;
...
uint16_t activity_rec(uint32_t seed)
{
