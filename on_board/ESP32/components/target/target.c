...
signed char DIRAM_ATTR fgetc2(uint8_t **fp)
{
    signed char ret = **fp;
    ++*fp;
    return ret;
...
void DIRAM_ATTR int_to_uchar(int32_t *r, uint8_t *in, int32_t size)
{
    int32_t i;
    int32_t max_r = r[0];
    int32_t min_r = r[0];
...
void DIRAM_ATTR edge_draw(uint8_t *in, uint8_t *mid, int32_t x_size, int32_t y_size, int32_t drawing_mode)
{
    int32_t i;
    uint8_t *inp, *midp;
...
void DIRAM_ATTR susan_principle_small(uint8_t *in, uint8_t *bp, int32_t *r, int32_t max_no, int32_t x_size, int32_t y_size)
{
    int32_t i, j, n;
    uint8_t *p, *cp;
...
void DIRAM_ATTR susan_edges_small(uint8_t *in, int32_t *r, uint8_t *mid, uint8_t *bp, int32_t max_no, int32_t x_size, int32_t y_size)
{
    float z;
...
int32_t DIRAM_ATTR susan_edges(uint8_t * in)
{
    	uint8_t *bp;
