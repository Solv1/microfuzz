...
uint8_t DIRAM_ATTR median(uint8_t *in, int32_t i, int32_t j, int32_t x_size)
{
    int32_t p[8], k, l, tmp;
...
void DIRAM_ATTR enlarge(uint8_t **in, uint8_t *tmp_image, int32_t *x_size, int32_t *y_size, int32_t border)
{
    int32_t i, j;
...
int16_t DIRAM_ATTR susan_smoothing(int32_t three_by_three, uint8_t *in, float dt, int32_t x_size, int32_t y_size, uint8_t *bp)
{
    float temp;
...
int32_t DIRAM_ATTR susan_smooth(uint8_t * in)
{
    uint8_t *bp;
