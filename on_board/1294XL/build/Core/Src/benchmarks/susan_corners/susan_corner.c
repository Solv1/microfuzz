...
int16_t get_image(uint8_t **fp, int32_t *x_size, int32_t *y_size)
{
    char header[100];
    int temp;
...
int16_t susan_corners_quick(uint8_t *in, int32_t *r, uint8_t *bp, int32_t max_no, CORNER_LIST corner_list, int32_t x_size, int32_t y_size)
{
    int32_t n, x, y, i, j;
    uint8_t *p, *cp;
...
int32_t susan_corners(uint8_t * in)
{
    	uint8_t *bp;
